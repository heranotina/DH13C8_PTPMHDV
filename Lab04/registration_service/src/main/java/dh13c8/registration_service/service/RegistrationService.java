package dh13c8.registration_service.service;

import dh13c8.registration_service.client.CourseClient;
import dh13c8.registration_service.dto.RegistrationRequestDTO;
import dh13c8.registration_service.enitity.Registration;
import dh13c8.registration_service.repository.RegistrationRepository;
...
// Day la gioi han da biet cua kien truc don gian hoa nay.
    ...
    public void cancel(Long registrationId) {
        Registration registration =
                registrationRepository.findById(registrationId).orElseThrow(() -> new NoSuchElementException("Khong tim thay dang ky id = " + registrationId));
